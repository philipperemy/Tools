...
public class Main
{
    ...
    public static void main(String[] args) throws IOException, TagException
    {
        ...
        for (int i = 0; i < mp3Files.size(); i++)
        {
            ...
            renameMap.put(mp3file, newFolder + "\\" + songEntity.getSongTitle() + ".mp3");

            System.out.println("old = " + mp3file.getName() + " new = " + renameMap.get(mp3file));
            ...
            if (mp3fileWrapper.hasID3v1Tag())
            {
                ...
                mp3fileWrapper.getID3v1Tag().setSongTitle(songEntity.getSongTitle());
                mp3fileWrapper.getID3v1Tag().setTitle(songEntity.getSongTitle());
                mp3fileWrapper.save();
            }
            else
            {
